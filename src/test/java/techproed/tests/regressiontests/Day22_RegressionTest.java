package techproed.tests.regressiontests;

public class Day22_RegressionTest {
    /*
    * * REGRESSION TEST * *
    ...
    Otomate edilemeyen bir durum belirtirmisiniz?
    Dogrulama gerekdiren storylerde automate edemiyoruz. Çünkü doğrulama telefondaki mobil uygulara geliyor
